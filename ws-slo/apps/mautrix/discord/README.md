...
appservice. An extra `matrix-discord-media` hostname on the synapse gateway
routes direct Discord media downloads to the bridge.

## Layout

- `base/` — sts.yaml, svc.yaml (http :29334), netpol.yaml (synapse only),
  pvc.yaml, vpa.yaml.
