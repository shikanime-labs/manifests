...
Mautrix bridge linking Matrix to Twitter/X, running
dock.mau.dev/mautrix/twitter as a single-replica StatefulSet. Serves the
appservice API on :29327 with live/ready probes under /_matrix/mau/*.
...
- `overlays/nishir-tailnet/` — config/doublepuppet/registration
  secretGenerator, tailscale Ingress `matrix-twitter`, netpol for
  tailscale-system.
