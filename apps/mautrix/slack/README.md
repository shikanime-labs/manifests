...
Mautrix bridge linking Matrix to Slack, running
dock.mau.dev/mautrix/slack as a single-replica StatefulSet. Serves the
appservice API on :29335 with live/ready probes under /_matrix/mau/*.
...
- `overlays/nishir-tailnet/` — config/doublepuppet/registration
  secretGenerator, tailscale Ingress `matrix-slack`, netpol for
  tailscale-system.
